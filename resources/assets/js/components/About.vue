<template>
    <div>
        <section class="site-hero site-hero-innerpage overlay" data-stellar-background-ratio="0.5" style="background-image: url(/template/images/big_image_1.jpg);">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row mb-5 align-items-center">
                    ...
                    <div class="col-md-6 overflow order-1">
                        <img src="template/images/img_1.jpg" alt="" class="img-fluid">
                    </div>
                ...
                <section class="school-features text-dark d-flex">
                    ...
                    <div class="inner">
                        <div class="media d-block feature text-center">
                            <img src="template/images/person_1.jpg" alt="Image placeholder" class="mb-3">
                        ...
                        <div class="media d-block feature text-center">
                            <img src="template/images/person_2.jpg" alt="Image placeholder" class="mb-3">
                            <div class="media-body">
                        ...
                        <div class="media d-block feature text-center">
                            <img src="template/images/person_3.jpg" alt="Image placeholder" class="mb-3">
                            <div class="media-body">
                        ...
                        <div class="media d-block feature text-center">
                            <img src="template/images/person_4.jpg" alt="Image placeholder" class="mb-3">
                            <div class="media-body">
